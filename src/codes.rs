    ...
    match is_store {
        None => {
            ...
            return match p2 {
                ...
                Some(n) => Args::Three(arg1, get_argument(&argl2[..n]),
        ...
        Some(p2) => {
            ...
            return match p1 {
                None => Args::Two(get_argument(&arg_line[..p2]),
                                  get_argument(&arg_line[p2+(1 as usize)..p3])),
                Some(n) => Args::Three(get_argument(&arg_line[..n]),
...
pub fn get_enc(instr : &InstrCode, args: Args<Arg>, lbl_adr : &HashMap<String, u32>, line: u32, adr: u32) -> Encoding {
    match instr.syntax {
        Syntax::ArithLog => {
